...
namespace Inventario {
    ...
    public partial class clienteDataSet : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clienteRow AddclienteRow(int idcliente, int idusuario, string nombrecliente) {
...
namespace Inventario.clienteDataSetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[cliente] WHERE (([idcliente] = @Original_idcliente) AND ([idus" +
                "uario] = @Original_idusuario) AND ([nombrecliente] = @Original_nombrecliente))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([idcliente], [idusuario], [nombrecliente]) VALUES (@" +
                "idcliente, @idusuario, @nombrecliente);\r\nSELECT idcliente, idusuario, nombreclie" +
                "nte FROM cliente WHERE (idcliente = @idcliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [idcliente] = @idcliente, [idusuario] = @idusuario, [nombrecliente] = @nombrecliente WHERE (([idcliente] = @Original_idcliente) AND ([idusuario] = @Original_idusuario) AND ([nombrecliente] = @Original_nombrecliente));
SELECT idcliente, idusuario, nombrecliente FROM cliente WHERE (idcliente = @idcliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idcliente, idusuario, nombrecliente FROM dbo.cliente";
        ...
        public virtual int Delete(int Original_idcliente, int Original_idusuario, string Original_nombrecliente) {
        ...
        public virtual int Insert(int idcliente, int idusuario, string nombrecliente) {
        ...
        public virtual int Update(int idcliente, int idusuario, string nombrecliente, int Original_idcliente, int Original_idusuario, string Original_nombrecliente) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int idusuario, string nombrecliente, int Original_idcliente, int Original_idusuario, string Original_nombrecliente) {
            return this.Update(Original_idcliente, idusuario, nombrecliente, Original_idcliente, Original_idusuario, Original_nombrecliente);
        }
    }
